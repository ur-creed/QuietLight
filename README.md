...
- **Platforms:** iOS (App Store) and Android (Google Play) — **1.3.0**.
...
**Current: v1.3.0** — newest first on the site; full history on the changelog page.

| Version | Highlights |
|---------|------------|
| **1.3.0** (latest) | Companion depth, visiting memory, quieter journal, share Today’s Light |
